...
public class ScaleDemo {
	...
	public ScaleDemo() {
		...
		while(true) {
			...
			// Change the scale factor. Our demo does a demonstration
			// of scale by changing the scale factor at each frame.
			d = d + 0.008;
			if (d > 3) {d = 0.5;}			
		
			// Scale the image
			imageScale = imageTank.scale(d,d);			
			
			// Draw the transformed image.
			window.draw(imageScale, 50, 50);			
	...
	public static void main(String[] args) {
		...
		ScaleDemo scaExemple = new ScaleDemo();
	}
